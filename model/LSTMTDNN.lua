...
function LSTMTDNN.lstmtdnn(
        ...
        length,             -- length = max length of a word
        use_words,          -- use_words = 1 if use word embeddings, otherwise not
        use_chars,          -- use_chars = 1 if use char embeddings, otherwise not
